    ...
    <Helmet>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          step: [
            { "@type": "HowToStep", position: 1, name: "Solicita tu cotización", text: "Llena el formulario con los detalles de tu viaje" },
            { "@type": "HowToStep", position: 2, name: "Envía tu cotización", text: "La información será enviada al conductor" },
            { "@type": "HowToStep", position: 3, name: "Confirmación del viaje", text: "El conductor te contactará para confirmar el costo del viaje" },
            { "@type": "HowToStep", position: 4, name: "¡Listo para viajar!", text: "Una vez confirmado, disfruta de tu viaje con nosotros" },
          ],
        })}
      </script>
        ...
        {JSON.stringify({
          ...
          mainEntity: {
            ...
            additionalProperty: [
              ...
              { "@type": "QuantitativeValue", name: "Tasa de puntualidad", value: 99, unitText: "PERCENT" },
              { "@type": "QuantitativeValue", name: "Kilómetros recorridos", value: 300000, unitText: "KILOMETER" },
              { "@type": "QuantitativeValue", name: "Trayectos seguros", value: 100, unitText: "PERCENT" },
              { "@type": "QuantitativeValue", name: "Años de experiencia", value: 9, unitText: "YEAR" },
              { "@type": "QuantitativeValue", name: "Viajes completados", value: 29850 },
              { "@type": "QuantitativeValue", name: "Clientes satisfechos", value: 19900 },
            ],
          },
        })}
      </script>
